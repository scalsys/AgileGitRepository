...
import org.scalsys.documents.portlet.list.bean.File;
import org.scalsys.documents.portlet.list.bean.Folder;
import org.scalsys.documents.portlet.list.bean.VersionBean;
import org.scalsys.documents.portlet.list.comparator.FileDateComparator;
import org.scalsys.documents.portlet.list.comparator.FileDateReverseComparator;
import org.scalsys.documents.portlet.list.comparator.FileNameComparator;
import org.scalsys.documents.portlet.list.comparator.FileNameReverseComparator;
import org.scalsys.documents.portlet.list.comparator.FileSizeComparator;
import org.scalsys.documents.portlet.list.comparator.FileSizeReverseComparator;
import org.scalsys.documents.portlet.validator.NameValidator;
...
//      e.printStackTrace();
  ...
  private static void checkIfHasMetaType(Node node) throws RepositoryException {
      ...
      System.out.println("NodeType"+node.getPrimaryNodeType());
      System.out.println("NodeMixinType"+node.getMixinNodeTypes());
	 if (!node.isNodeType(META_NODETYPE))
    {
  ...
  public static Long updateTimestamp(Node node) throws RepositoryException {
    ...
    System.out.println("checking node sucessfully");
